<!-- $FreeBSD: src/release/doc/en_US.ISO8859-1/share/sgml/release.dsl,v 1.1.2.7.2.1 2003/03/28 23:19:50 bmah Exp $ -->
        ...
        (define ($create-refentry-xref-link$ #!optional (n (current-node)))
          (let* ((r (select-elements (children n) (normalize "refentrytitle")))
            ...
            (case v
              ...
              (else        (string-append u "&" "manpath=FreeBSD+4.8-RELEASE")))))
      ]]>
