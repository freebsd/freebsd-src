/*
 *  linux/arch/arm/mach-sa1100/leds-adsagc.c
 *
 * ADS Advanced Graphics Client LEDs support
 * Robert Whaley, Feb 7, 2003
 */
...
void adsagc_leds_event(led_event_t evt)
{
	unsigned long flags;
	...
	if  (led_state & LED_STATE_ENABLED) {
	        ...
	        unsigned char ads_cr3 = ADS_CR3;
		ads_cr3 &= ~LED_MASK;
		ads_cr3 |= hw_led_state;
		ADS_CR3 = ads_cr3;
	}
