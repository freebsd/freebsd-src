/* $FreeBSD: src/lib/libc/nls/msgcat.c,v 1.21.2.3 2000/09/08 11:44:09 ache Exp $ */
...
static char *rcsid = "$FreeBSD: src/lib/libc/nls/msgcat.c,v 1.21.2.3 2000/09/08 11:44:09 ache Exp $";
