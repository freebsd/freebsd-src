 ...
 *
 *	@(#) $FreeBSD: src/lib/libatm/ioctl_subr.c,v 1.1.2.1 1999/08/29 14:55:19 peter Exp $
 *
 */
...
#ifndef lint
static char *RCSid = "@(#) $FreeBSD: src/lib/libatm/ioctl_subr.c,v 1.1.2.1 1999/08/29 14:55:19 peter Exp $";
#endif
