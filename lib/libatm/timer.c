 ...
 *
 *	@(#) $FreeBSD: src/lib/libatm/timer.c,v 1.1.2.1 1999/08/29 14:55:20 peter Exp $
 *
 */
...
#ifndef lint
static char *RCSid = "@(#) $FreeBSD: src/lib/libatm/timer.c,v 1.1.2.1 1999/08/29 14:55:20 peter Exp $";
#endif
