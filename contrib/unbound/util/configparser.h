...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    VAR_TLS_PROTOCOLS = 590,       /* VAR_TLS_PROTOCOLS  */
    VAR_IPSET = 591,               /* VAR_IPSET  */
    VAR_IPSET_NAME_V4 = 592,       /* VAR_IPSET_NAME_V4  */
    VAR_IPSET_NAME_V6 = 593,       /* VAR_IPSET_NAME_V6  */
    VAR_TLS_SESSION_TICKET_KEYS = 594, /* VAR_TLS_SESSION_TICKET_KEYS  */
    VAR_RPZ = 595,                 /* VAR_RPZ  */
    VAR_TAGS = 596,                /* VAR_TAGS  */
    VAR_RPZ_ACTION_OVERRIDE = 597, /* VAR_RPZ_ACTION_OVERRIDE  */
    VAR_RPZ_CNAME_OVERRIDE = 598,  /* VAR_RPZ_CNAME_OVERRIDE  */
    VAR_RPZ_LOG = 599,             /* VAR_RPZ_LOG  */
    VAR_RPZ_LOG_NAME = 600,        /* VAR_RPZ_LOG_NAME  */
    VAR_DYNLIB = 601,              /* VAR_DYNLIB  */
    VAR_DYNLIB_FILE = 602,         /* VAR_DYNLIB_FILE  */
    VAR_EDNS_CLIENT_STRING = 603,  /* VAR_EDNS_CLIENT_STRING  */
    VAR_EDNS_CLIENT_STRING_OPCODE = 604, /* VAR_EDNS_CLIENT_STRING_OPCODE  */
    VAR_NSID = 605,                /* VAR_NSID  */
    VAR_ZONEMD_PERMISSIVE_MODE = 606, /* VAR_ZONEMD_PERMISSIVE_MODE  */
    VAR_ZONEMD_CHECK = 607,        /* VAR_ZONEMD_CHECK  */
    VAR_ZONEMD_REJECT_ABSENCE = 608, /* VAR_ZONEMD_REJECT_ABSENCE  */
    VAR_RPZ_SIGNAL_NXDOMAIN_RA = 609, /* VAR_RPZ_SIGNAL_NXDOMAIN_RA  */
    VAR_INTERFACE_AUTOMATIC_PORTS = 610, /* VAR_INTERFACE_AUTOMATIC_PORTS  */
    VAR_EDE = 611,                 /* VAR_EDE  */
    VAR_DNS_ERROR_REPORTING = 612, /* VAR_DNS_ERROR_REPORTING  */
    VAR_INTERFACE_ACTION = 613,    /* VAR_INTERFACE_ACTION  */
    VAR_INTERFACE_VIEW = 614,      /* VAR_INTERFACE_VIEW  */
    VAR_INTERFACE_TAG = 615,       /* VAR_INTERFACE_TAG  */
    VAR_INTERFACE_TAG_ACTION = 616, /* VAR_INTERFACE_TAG_ACTION  */
    VAR_INTERFACE_TAG_DATA = 617,  /* VAR_INTERFACE_TAG_DATA  */
    VAR_QUIC_PORT = 618,           /* VAR_QUIC_PORT  */
    VAR_QUIC_SIZE = 619,           /* VAR_QUIC_SIZE  */
    VAR_PROXY_PROTOCOL_PORT = 620, /* VAR_PROXY_PROTOCOL_PORT  */
    VAR_STATISTICS_INHIBIT_ZERO = 621, /* VAR_STATISTICS_INHIBIT_ZERO  */
    VAR_HARDEN_UNKNOWN_ADDITIONAL = 622, /* VAR_HARDEN_UNKNOWN_ADDITIONAL  */
    VAR_DISABLE_EDNS_DO = 623,     /* VAR_DISABLE_EDNS_DO  */
    VAR_CACHEDB_NO_STORE = 624,    /* VAR_CACHEDB_NO_STORE  */
    VAR_LOG_DESTADDR = 625,        /* VAR_LOG_DESTADDR  */
    VAR_CACHEDB_CHECK_WHEN_SERVE_EXPIRED = 626, /* VAR_CACHEDB_CHECK_WHEN_SERVE_EXPIRED  */
    VAR_COOKIE_SECRET_FILE = 627,  /* VAR_COOKIE_SECRET_FILE  */
    VAR_ITER_SCRUB_NS = 628,       /* VAR_ITER_SCRUB_NS  */
    VAR_ITER_SCRUB_CNAME = 629,    /* VAR_ITER_SCRUB_CNAME  */
    VAR_ITER_SCRUB_RRSIG = 630,    /* VAR_ITER_SCRUB_RRSIG  */
    VAR_MAX_GLOBAL_QUOTA = 631,    /* VAR_MAX_GLOBAL_QUOTA  */
    VAR_HARDEN_UNVERIFIED_GLUE = 632, /* VAR_HARDEN_UNVERIFIED_GLUE  */
    VAR_LOG_TIME_ISO = 633,        /* VAR_LOG_TIME_ISO  */
    VAR_ITER_SCRUB_PROMISCUOUS = 634, /* VAR_ITER_SCRUB_PROMISCUOUS  */
    VAR_LOG_THREAD_ID = 635        /* VAR_LOG_THREAD_ID  */
  };
...
#define VAR_ITER_SCRUB_RRSIG 630
#define VAR_MAX_GLOBAL_QUOTA 631
#define VAR_HARDEN_UNVERIFIED_GLUE 632
#define VAR_LOG_TIME_ISO 633
#define VAR_ITER_SCRUB_PROMISCUOUS 634
#define VAR_LOG_THREAD_ID 635
