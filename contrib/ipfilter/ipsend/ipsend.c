/* $FreeBSD: src/contrib/ipfilter/ipsend/ipsend.c,v 1.10 2003/02/15 06:32:48 darrenr Exp $ */
/*
...
static const char rcsid[] = "@(#)$FreeBSD: src/contrib/ipfilter/ipsend/ipsend.c,v 1.10 2003/02/15 06:32:48 darrenr Exp $";
#endif
