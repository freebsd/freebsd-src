 ...
 *
 *      @(#) $FreeBSD: src/sbin/atm/ilmid/ilmid.c,v 1.13 2002/10/10 00:27:17 alfred Exp $
 *
 */
...
#ifndef	lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/ilmid/ilmid.c,v 1.13 2002/10/10 00:27:17 alfred Exp $");
#endif
