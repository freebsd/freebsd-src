 ...
 *
 *      @(#) $FreeBSD: src/sbin/atm/ilmid/ilmid.c,v 1.31 2003/07/25 08:15:09 harti Exp $
 *
 */
...
#ifndef	lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/ilmid/ilmid.c,v 1.31 2003/07/25 08:15:09 harti Exp $");
#endif
