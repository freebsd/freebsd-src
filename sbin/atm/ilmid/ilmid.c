 ...
 *
 *      @(#) $FreeBSD: src/sbin/atm/ilmid/ilmid.c,v 1.6.2.1 2000/07/01 06:11:51 ps Exp $
 *
 */
...
#ifndef	lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/ilmid/ilmid.c,v 1.6.2.1 2000/07/01 06:11:51 ps Exp $");
#endif
