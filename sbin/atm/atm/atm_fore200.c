 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/atm/atm_fore200.c,v 1.5 2002/05/17 00:20:40 arr Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/atm/atm_fore200.c,v 1.5 2002/05/17 00:20:40 arr Exp $");
#endif
