 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/atm/atm_print.c,v 1.7 2003/07/28 08:14:27 harti Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/atm/atm_print.c,v 1.7 2003/07/28 08:14:27 harti Exp $");
#endif
