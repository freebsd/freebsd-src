 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/atm/atm_inet.c,v 1.1.2.1 1999/08/29 15:12:22 peter Exp $
 *
 */
...
#ifndef lint
static char *RCSid = "@(#) $FreeBSD: src/sbin/atm/atm/atm_inet.c,v 1.1.2.1 1999/08/29 15:12:22 peter Exp $";
#endif
