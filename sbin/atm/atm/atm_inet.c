 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/atm/atm_inet.c,v 1.3.2.2 2003/08/22 14:52:06 harti Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/atm/atm_inet.c,v 1.3.2.2 2003/08/22 14:52:06 harti Exp $");
#endif
