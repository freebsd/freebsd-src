 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/atm/atm_subr.c,v 1.6 2002/06/07 05:25:10 mdodd Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/atm/atm_subr.c,v 1.6 2002/06/07 05:25:10 mdodd Exp $");
#endif
