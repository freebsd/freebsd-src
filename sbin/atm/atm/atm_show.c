 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/atm/atm_show.c,v 1.3.2.2 2003/07/22 15:04:50 harti Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/atm/atm_show.c,v 1.3.2.2 2003/07/22 15:04:50 harti Exp $");
#endif
