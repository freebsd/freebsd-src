 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/fore_dnld/fore_dnld.c,v 1.6.2.1 2000/07/01 06:06:46 ps Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/fore_dnld/fore_dnld.c,v 1.6.2.1 2000/07/01 06:06:46 ps Exp $");
#endif
