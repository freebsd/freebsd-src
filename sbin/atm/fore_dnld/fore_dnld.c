 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/fore_dnld/fore_dnld.c,v 1.6.2.4 2003/08/20 11:15:42 harti Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/fore_dnld/fore_dnld.c,v 1.6.2.4 2003/08/20 11:15:42 harti Exp $");
#endif
