 ...
 *
 *	@(#) $FreeBSD: src/sbin/atm/fore_dnld/fore_dnld.c,v 1.6 2000/02/15 13:20:58 phk Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sbin/atm/fore_dnld/fore_dnld.c,v 1.6 2000/02/15 13:20:58 phk Exp $");
#endif
