...
struct sysent osf1_sysent[] = {
	...
	{ AS(ogethostname_args), (sy_call_t *)ogethostname },	/* 87 = ogethostname */
	{ AS(osethostname_args), (sy_call_t *)osethostname },	/* 88 = osethostname */
	...
	{ AS(oaccept_args), (sy_call_t *)oaccept },	/* 99 = oaccept */
	...
	{ AS(orecvfrom_args), (sy_call_t *)orecvfrom },	/* 125 = orecvfrom */
	...
	{ AS(ogetsockname_args), (sy_call_t *)ogetsockname },	/* 150 = ogetsockname */
