/*	$FreeBSD: src/sys/dev/ral/rt2560.c,v 1.17.2.1.2.1 2008/11/25 02:59:29 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/rt2560.c,v 1.17.2.1.2.1 2008/11/25 02:59:29 kensmith Exp $");
