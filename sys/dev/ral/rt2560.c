/*	$FreeBSD: src/sys/dev/ral/rt2560.c,v 1.33.2.1.2.1 2009/10/25 01:10:29 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/rt2560.c,v 1.33.2.1.2.1 2009/10/25 01:10:29 kensmith Exp $");
