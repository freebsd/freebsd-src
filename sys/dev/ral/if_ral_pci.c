/*	$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.7.12.1 2010/12/21 17:10:29 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.7.12.1 2010/12/21 17:10:29 kensmith Exp $");
