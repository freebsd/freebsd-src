/*	$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.7.10.1 2010/02/10 00:26:20 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.7.10.1 2010/02/10 00:26:20 kensmith Exp $");
