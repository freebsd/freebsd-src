/*	$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.1.2.2.4.1 2008/10/02 02:57:24 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.1.2.2.4.1 2008/10/02 02:57:24 kensmith Exp $");
