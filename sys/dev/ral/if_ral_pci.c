/*	$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.9.2.1.4.1 2010/06/14 02:09:06 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.9.2.1.4.1 2010/06/14 02:09:06 kensmith Exp $");
