/*	$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.9.2.1.8.1 2012/03/03 06:15:13 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.9.2.1.8.1 2012/03/03 06:15:13 kensmith Exp $");
