/*	$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.7.6.1 2008/11/25 02:59:29 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/ral/if_ral_pci.c,v 1.7.6.1 2008/11/25 02:59:29 kensmith Exp $");
