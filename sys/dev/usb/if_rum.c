/*	$FreeBSD: src/sys/dev/usb/if_rum.c,v 1.13.2.2.6.1 2010/02/10 00:26:20 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/usb/if_rum.c,v 1.13.2.2.6.1 2010/02/10 00:26:20 kensmith Exp $");
