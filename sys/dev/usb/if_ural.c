/*	$FreeBSD: src/sys/dev/usb/if_ural.c,v 1.10.2.4 2005/09/26 17:21:15 damien Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/usb/if_ural.c,v 1.10.2.4 2005/09/26 17:21:15 damien Exp $");
