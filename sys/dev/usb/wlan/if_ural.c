/*	$FreeBSD: src/sys/dev/usb/wlan/if_ural.c,v 1.20.2.13.2.1 2012/03/03 06:15:13 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/usb/wlan/if_ural.c,v 1.20.2.13.2.1 2012/03/03 06:15:13 kensmith Exp $");
