...
/*	$FreeBSD: src/sys/dev/usb/wlan/if_zyd.c,v 1.22.2.3.2.1 2009/10/25 01:10:29 kensmith Exp $	*/
...
#include <sys/cdefs.h>
__FBSDID("$FreeBSD: src/sys/dev/usb/wlan/if_zyd.c,v 1.22.2.3.2.1 2009/10/25 01:10:29 kensmith Exp $");
