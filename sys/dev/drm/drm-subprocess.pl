# $FreeBSD: src/sys/dev/drm/drm-subprocess.pl,v 1.2.2.1.4.1 2010/06/14 02:09:06 kensmith Exp $
#
...
while (<>) {
	...
	if (!$foundopening) {
		...
		# print the $FreeBSD: src/sys/dev/drm/drm-subprocess.pl,v 1.2.2.1.4.1 2010/06/14 02:09:06 kensmith Exp $ bits after the end of the license block
		$foundclosing = 1;
		print;
		print "\n";
