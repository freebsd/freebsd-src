# $FreeBSD: src/sys/dev/drm/drm-subprocess.pl,v 1.2.2.1.2.1 2009/10/25 01:10:29 kensmith Exp $
#
...
while (<>) {
	...
	if (!$foundopening) {
		...
		# print the $FreeBSD: src/sys/dev/drm/drm-subprocess.pl,v 1.2.2.1.2.1 2009/10/25 01:10:29 kensmith Exp $ bits after the end of the license block
		$foundclosing = 1;
		print;
		print "\n";
