...
# $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.2.1.6.1 2008/10/02 02:57:24 kensmith Exp $
...
# Replace drm_pciids.h with one with a $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.2.1.6.1 2008/10/02 02:57:24 kensmith Exp $
