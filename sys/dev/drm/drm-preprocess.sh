...
# $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.12.1.4.1 2010/06/14 02:09:06 kensmith Exp $
...
# Replace drm_pciids.h with one with a $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.12.1.4.1 2010/06/14 02:09:06 kensmith Exp $
