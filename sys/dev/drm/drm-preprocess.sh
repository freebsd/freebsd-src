...
# $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.14.1 2010/02/10 00:26:20 kensmith Exp $
...
# Replace drm_pciids.h with one with a $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.14.1 2010/02/10 00:26:20 kensmith Exp $
