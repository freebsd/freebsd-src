...
# $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.12.1.2.1 2009/10/25 01:10:29 kensmith Exp $
...
# Replace drm_pciids.h with one with a $FreeBSD: src/sys/dev/drm/drm-preprocess.sh,v 1.3.12.1.2.1 2009/10/25 01:10:29 kensmith Exp $
