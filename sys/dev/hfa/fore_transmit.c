 ...
 *
 *	@(#) $FreeBSD: src/sys/dev/hfa/fore_transmit.c,v 1.9 2002/06/24 05:03:44 arr Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sys/dev/hfa/fore_transmit.c,v 1.9 2002/06/24 05:03:44 arr Exp $");
#endif
