 ...
 *
 *	@(#) $FreeBSD: src/sys/dev/hfa/fore_output.c,v 1.18.2.1 2005/01/30 00:59:44 imp Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sys/dev/hfa/fore_output.c,v 1.18.2.1 2005/01/30 00:59:44 imp Exp $");
#endif
