 ...
 *
 *	@(#) $FreeBSD: src/sys/dev/hfa/fore_command.c,v 1.18.2.1 2005/01/30 00:59:43 imp Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sys/dev/hfa/fore_command.c,v 1.18.2.1 2005/01/30 00:59:43 imp Exp $");
#endif
