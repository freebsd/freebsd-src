 ...
 *
 *	@(#) $FreeBSD: src/sys/dev/hfa/fore_init.c,v 1.16.2.1 2005/01/30 00:59:43 imp Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sys/dev/hfa/fore_init.c,v 1.16.2.1 2005/01/30 00:59:43 imp Exp $");
#endif
