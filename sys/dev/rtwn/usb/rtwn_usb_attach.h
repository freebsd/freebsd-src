...
#define RTWN_RTL8192CU_DEV(v,p) \
	{ USB_VPI(USB_VENDOR_##v, USB_PRODUCT_##v##_##p, \
	  RTWN_USB_DEVINFO(RTWN_CHIP_RTL8192CU, 0)) }
...
#define RTWN_RTL8192EU_DEV(v,p) \
	{ USB_VPI(USB_VENDOR_##v, USB_PRODUCT_##v##_##p, \
	  RTWN_USB_DEVINFO(RTWN_CHIP_RTL8192EU, 0)) }
...
#define RTWN_RTL8188EU_DEV(v,p) \
	{ USB_VPI(USB_VENDOR_##v, USB_PRODUCT_##v##_##p, \
	  RTWN_USB_DEVINFO(RTWN_CHIP_RTL8188EU, 0)) }
...
#undef RTWN_RTL8188EU_DEV
	...
	/* RTL8723BU */
#define RTWN_RTL8723BU_DEV(v, p, i) \
	{ USB_VP(USB_VENDOR_##v, USB_PRODUCT_##v##_##p), \
	  USB_IF_CSI(UICLASS_VENDOR, UISUBCLASS_VENDOR, \
	  RTWN_USB_DEVINFO(RTWN_CHIP_RTL8723BU, i)) }
	RTWN_RTL8723BU_DEV(EDIMAX,		EW7611ULB,	2),
	RTWN_RTL8723BU_DEV(REALTEK,		RTL8723BU,	2),
#undef RTWN_RTL8723BU_DEV

	/* RTL8812AU */
#define RTWN_RTL8812AU_DEV(v,p) \
	{ USB_VPI(USB_VENDOR_##v, USB_PRODUCT_##v##_##p, \
	  RTWN_USB_DEVINFO(RTWN_CHIP_RTL8812AU, 0)) }
...
#define RTWN_RTL8821AU_DEV(v,p) \
	{ USB_VPI(USB_VENDOR_##v, USB_PRODUCT_##v##_##p, \
	  RTWN_USB_DEVINFO(RTWN_CHIP_RTL8821AU, 0)) }
