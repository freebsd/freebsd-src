 ...
 * $FreeBSD: src/sys/amd64/linux32/linux32_syscall.h,v 1.5.2.3.2.2 2007/12/08 13:46:03 dwmalone Exp $
 * created from FreeBSD: src/sys/amd64/linux32/syscalls.master,v 1.4.2.3.2.1 2007/12/08 13:43:47 dwmalone Exp 
 */
