 ...
 * $FreeBSD: src/sys/amd64/linux32/linux32_sysent.c,v 1.5.2.3.2.2 2007/12/08 13:46:03 dwmalone Exp $
...
#define	nosys	linux_nosys
	...
	{ SYF_MPSAFE | AS(linux_clock_settime_args), (sy_call_t *)linux_clock_settime, AUE_NULL },	/* 264 = linux_clock_settime */
	{ SYF_MPSAFE | AS(linux_clock_gettime_args), (sy_call_t *)linux_clock_gettime, AUE_NULL },	/* 265 = linux_clock_gettime */
	{ SYF_MPSAFE | AS(linux_clock_getres_args), (sy_call_t *)linux_clock_getres, AUE_NULL },	/* 266 = linux_clock_getres */
	{ SYF_MPSAFE | AS(linux_clock_nanosleep_args), (sy_call_t *)linux_clock_nanosleep, AUE_NULL },	/* 267 = linux_clock_nanosleep */
	{ SYF_MPSAFE | AS(linux_statfs64_args), (sy_call_t *)linux_statfs64, AUE_NULL },	/* 268 = linux_statfs64 */
	{ SYF_MPSAFE | 0, (sy_call_t *)linux_fstatfs64, AUE_NULL },	/* 269 = linux_fstatfs64 */
	{ SYF_MPSAFE | AS(linux_tgkill_args), (sy_call_t *)linux_tgkill, AUE_NULL },	/* 270 = linux_tgkill */
	{ SYF_MPSAFE | AS(linux_utimes_args), (sy_call_t *)linux_utimes, AUE_NULL },	/* 271 = linux_utimes */
	...
	{ SYF_MPSAFE | AS(linux_openat_args), (sy_call_t *)linux_openat, AUE_NULL },	/* 295 = linux_openat */
