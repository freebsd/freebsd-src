...
#if defined(__FreeBSD__)
MODULE_PARM_DESC(wed_enable, "WED enabled");
#endif
...
#elif defined(__FreeBSD__)
	if (!linuxkpi_pci_get_device(PCI_VENDOR_ID_MEDIATEK, 0x7916, NULL) &&
	    !linuxkpi_pci_get_device(PCI_VENDOR_ID_MEDIATEK, 0x790a, NULL))
#endif
		return NULL;
