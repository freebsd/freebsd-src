/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.48.2.2.6.1 2012/03/03 06:15:13 kensmith Exp $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.48.2.2.6.1 2012/03/03 06:15:13 kensmith Exp $";
