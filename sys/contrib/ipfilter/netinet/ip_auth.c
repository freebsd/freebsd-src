/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.44.2.2.10.1 2010/12/21 17:10:29 kensmith Exp $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.44.2.2.10.1 2010/12/21 17:10:29 kensmith Exp $";
