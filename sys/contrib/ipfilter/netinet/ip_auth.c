/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.44.2.2.4.1 2008/11/25 02:59:29 kensmith Exp $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.44.2.2.4.1 2008/11/25 02:59:29 kensmith Exp $";
