/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.48.2.2.2.1 2010/06/14 02:09:06 kensmith Exp $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.48.2.2.2.1 2010/06/14 02:09:06 kensmith Exp $";
