/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.40.2.3.2.1 2008/10/02 02:57:24 kensmith Exp $	*/
...
#if !defined(lint)
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_auth.c,v 1.40.2.3.2.1 2008/10/02 02:57:24 kensmith Exp $";
