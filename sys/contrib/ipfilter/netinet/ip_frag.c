/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_frag.c,v 1.32.2.1.8.1 2010/02/10 00:26:20 kensmith Exp $	*/
...
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_frag.c,v 1.32.2.1.8.1 2010/02/10 00:26:20 kensmith Exp $";
