/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_frag.c,v 1.32.2.1.10.1 2010/12/21 17:10:29 kensmith Exp $	*/
...
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_frag.c,v 1.32.2.1.10.1 2010/12/21 17:10:29 kensmith Exp $";
