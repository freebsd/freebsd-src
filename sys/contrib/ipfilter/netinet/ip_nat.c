/*	$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_nat.c,v 1.42.2.1.8.1 2010/02/10 00:26:20 kensmith Exp $	*/
...
static const char rcsid[] = "@(#)$FreeBSD: src/sys/contrib/ipfilter/netinet/ip_nat.c,v 1.42.2.1.8.1 2010/02/10 00:26:20 kensmith Exp $";
