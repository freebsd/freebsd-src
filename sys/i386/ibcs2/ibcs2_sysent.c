...
struct sysent ibcs2_sysent[] = {
	...
	{ SYF_MPSAFE | AS(ibcs2_read_args), (sy_call_t *)ibcs2_read, AUE_NULL },	/* 3 = ibcs2_read */
	...
	{ SYF_MPSAFE | AS(ibcs2_mount_args), (sy_call_t *)ibcs2_mount, AUE_MOUNT },	/* 21 = ibcs2_mount */
	{ SYF_MPSAFE | AS(ibcs2_umount_args), (sy_call_t *)ibcs2_umount, AUE_UMOUNT },	/* 22 = ibcs2_umount */
	...
	{ SYF_MPSAFE | AS(ibcs2_msgsys_args), (sy_call_t *)ibcs2_msgsys, AUE_MSGSYS },	/* 49 = ibcs2_msgsys */
	{ SYF_MPSAFE | AS(ibcs2_sysi86_args), (sy_call_t *)ibcs2_sysi86, AUE_NULL },	/* 50 = ibcs2_sysi86 */
	{ 0, (sy_call_t *)nosys, AUE_NULL },			/* 51 = ibcs2_acct */
	{ SYF_MPSAFE | AS(ibcs2_shmsys_args), (sy_call_t *)ibcs2_shmsys, AUE_SHMSYS },	/* 52 = ibcs2_shmsys */
	{ SYF_MPSAFE | AS(ibcs2_semsys_args), (sy_call_t *)ibcs2_semsys, AUE_SEMSYS },	/* 53 = ibcs2_semsys */
	{ SYF_MPSAFE | AS(ibcs2_ioctl_args), (sy_call_t *)ibcs2_ioctl, AUE_IOCTL },	/* 54 = ibcs2_ioctl */
	...
	{ SYF_MPSAFE | AS(ibcs2_getdents_args), (sy_call_t *)ibcs2_getdents, AUE_GETDIRENTRIES },	/* 81 = ibcs2_getdents */
