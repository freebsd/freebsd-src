...
struct sysent ibcs2_sysent[] = {
	...
	{ AS(ibcs2_open_args), (sy_call_t *)ibcs2_open, AUE_NULL },	/* 5 = ibcs2_open */
	...
	{ AS(ibcs2_creat_args), (sy_call_t *)ibcs2_creat, AUE_NULL },	/* 8 = ibcs2_creat */
	{ AS(link_args), (sy_call_t *)link, AUE_NULL },	/* 9 = link */
	{ AS(ibcs2_unlink_args), (sy_call_t *)ibcs2_unlink, AUE_NULL },	/* 10 = ibcs2_unlink */
	{ AS(ibcs2_execv_args), (sy_call_t *)ibcs2_execv, AUE_NULL },	/* 11 = ibcs2_execv */
	{ AS(ibcs2_chdir_args), (sy_call_t *)ibcs2_chdir, AUE_NULL },	/* 12 = ibcs2_chdir */
	{ AS(ibcs2_time_args), (sy_call_t *)ibcs2_time, AUE_NULL },	/* 13 = ibcs2_time */
	{ AS(ibcs2_mknod_args), (sy_call_t *)ibcs2_mknod, AUE_NULL },	/* 14 = ibcs2_mknod */
	{ AS(ibcs2_chmod_args), (sy_call_t *)ibcs2_chmod, AUE_NULL },	/* 15 = ibcs2_chmod */
	{ AS(ibcs2_chown_args), (sy_call_t *)ibcs2_chown, AUE_NULL },	/* 16 = ibcs2_chown */
	{ AS(obreak_args), (sy_call_t *)obreak, AUE_NULL },	/* 17 = obreak */
	{ AS(ibcs2_stat_args), (sy_call_t *)ibcs2_stat, AUE_NULL },	/* 18 = ibcs2_stat */
	{ AS(ibcs2_lseek_args), (sy_call_t *)ibcs2_lseek, AUE_NULL },	/* 19 = ibcs2_lseek */
	...
	{ AS(ibcs2_stime_args), (sy_call_t *)ibcs2_stime, AUE_NULL },	/* 25 = ibcs2_stime */
	...
	{ AS(ibcs2_fstat_args), (sy_call_t *)ibcs2_fstat, AUE_NULL },	/* 28 = ibcs2_fstat */
	...
	{ AS(ibcs2_access_args), (sy_call_t *)ibcs2_access, AUE_NULL },	/* 33 = ibcs2_access */
	{ SYF_MPSAFE | AS(ibcs2_nice_args), (sy_call_t *)ibcs2_nice, AUE_NULL },	/* 34 = ibcs2_nice */
	{ AS(ibcs2_statfs_args), (sy_call_t *)ibcs2_statfs, AUE_NULL },	/* 35 = ibcs2_statfs */
	{ 0, (sy_call_t *)sync, AUE_NULL },		/* 36 = sync */
	{ SYF_MPSAFE | AS(ibcs2_kill_args), (sy_call_t *)ibcs2_kill, AUE_NULL },	/* 37 = ibcs2_kill */
	{ AS(ibcs2_fstatfs_args), (sy_call_t *)ibcs2_fstatfs, AUE_NULL },	/* 38 = ibcs2_fstatfs */
	...
	{ AS(ibcs2_execve_args), (sy_call_t *)ibcs2_execve, AUE_NULL },	/* 59 = ibcs2_execve */
	...
	{ AS(ibcs2_rmdir_args), (sy_call_t *)ibcs2_rmdir, AUE_NULL },	/* 79 = ibcs2_rmdir */
	{ AS(ibcs2_mkdir_args), (sy_call_t *)ibcs2_mkdir, AUE_NULL },	/* 80 = ibcs2_mkdir */
	...
	{ AS(ibcs2_getmsg_args), (sy_call_t *)ibcs2_getmsg, AUE_NULL },	/* 85 = ibcs2_getmsg */
	{ AS(ibcs2_putmsg_args), (sy_call_t *)ibcs2_putmsg, AUE_NULL },	/* 86 = ibcs2_putmsg */
	...
	{ AS(ibcs2_symlink_args), (sy_call_t *)ibcs2_symlink, AUE_NULL },	/* 90 = ibcs2_symlink */
	{ AS(ibcs2_lstat_args), (sy_call_t *)ibcs2_lstat, AUE_NULL },	/* 91 = ibcs2_lstat */
	{ AS(ibcs2_readlink_args), (sy_call_t *)ibcs2_readlink, AUE_NULL },	/* 92 = ibcs2_readlink */
