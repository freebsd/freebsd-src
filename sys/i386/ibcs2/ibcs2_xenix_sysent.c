...
struct sysent xenix_sysent[] = {
	...
	{ AS(xenix_chsize_args), (sy_call_t *)xenix_chsize, AUE_NULL },	/* 10 = xenix_chsize */
	...
	{ AS(select_args), (sy_call_t *)select, AUE_NULL },	/* 36 = select */
	{ AS(xenix_eaccess_args), (sy_call_t *)xenix_eaccess, AUE_NULL },	/* 37 = xenix_eaccess */
	...
	{ AS(ibcs2_pathconf_args), (sy_call_t *)ibcs2_pathconf, AUE_NULL },	/* 46 = ibcs2_pathconf */
	{ AS(ibcs2_fpathconf_args), (sy_call_t *)ibcs2_fpathconf, AUE_NULL },	/* 47 = ibcs2_fpathconf */
	{ AS(ibcs2_rename_args), (sy_call_t *)ibcs2_rename, AUE_NULL },	/* 48 = ibcs2_rename */
	...
	{ AS(getitimer_args), (sy_call_t *)getitimer, AUE_NULL },	/* 55 = getitimer */
	{ AS(setitimer_args), (sy_call_t *)setitimer, AUE_NULL },	/* 56 = setitimer */
};
