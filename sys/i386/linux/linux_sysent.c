 ...
 * $FreeBSD: src/sys/i386/linux/linux_sysent.c,v 1.33.2.6 2001/08/27 09:05:30 alc Exp $
 * created from FreeBSD: src/sys/i386/linux/syscalls.master,v 1.30.2.5 2001/08/27 08:51:16 alc Exp 
 */
