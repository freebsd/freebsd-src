 ...
 * $FreeBSD$
 * created from FreeBSD: src/sys/i386/linux/syscalls.master,v 1.63 2006/02/06 01:40:30 rwatson Exp 
 */
...
#define	nosys	linux_nosys
	...
	{ SYF_MPSAFE | AS(linux_fstat_args), (sy_call_t *)linux_fstat, AUE_FSTAT },	/* 28 = linux_fstat */
	...
	{ SYF_MPSAFE | AS(sethostname_args), (sy_call_t *)osethostname, AUE_SYSCTL },	/* 74 = osethostname */
	...
	{ SYF_MPSAFE | AS(getrusage_args), (sy_call_t *)getrusage, AUE_GETRUSAGE },	/* 77 = getrusage */
	{ SYF_MPSAFE | AS(gettimeofday_args), (sy_call_t *)gettimeofday, AUE_NULL },	/* 78 = gettimeofday */
	{ SYF_MPSAFE | AS(settimeofday_args), (sy_call_t *)settimeofday, AUE_SETTIMEOFDAY },	/* 79 = settimeofday */
	...
	{ SYF_MPSAFE | AS(ostat_args), (sy_call_t *)ostat, AUE_STAT },	/* 84 = ostat */
	...
	{ SYF_MPSAFE | AS(oftruncate_args), (sy_call_t *)oftruncate, AUE_FTRUNCATE },	/* 93 = oftruncate */
	...
	{ SYF_MPSAFE | AS(mprotect_args), (sy_call_t *)mprotect, AUE_MPROTECT },	/* 125 = mprotect */
	...
	{ SYF_MPSAFE | AS(readv_args), (sy_call_t *)readv, AUE_READV },	/* 145 = readv */
	{ SYF_MPSAFE | AS(writev_args), (sy_call_t *)writev, AUE_WRITEV },	/* 146 = writev */
	...
	{ SYF_MPSAFE | AS(sched_rr_get_interval_args), (sy_call_t *)sched_rr_get_interval, AUE_SCHED_RR_GET_INTERVAL },	/* 161 = sched_rr_get_interval */
