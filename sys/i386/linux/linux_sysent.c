 ...
 * $FreeBSD: src/sys/i386/linux/linux_sysent.c,v 1.65.2.3.2.2 2007/12/08 13:46:03 dwmalone Exp $
 * created from FreeBSD: src/sys/i386/linux/syscalls.master,v 1.61.2.3.2.1 2007/12/08 13:43:48 dwmalone Exp 
 */
...
#define	nosys	linux_nosys
	...
	{ SYF_MPSAFE | AS(linux_timer_create_args), (sy_call_t *)linux_timer_create, AUE_NULL },	/* 259 = linux_timer_create */
	{ SYF_MPSAFE | AS(linux_timer_settime_args), (sy_call_t *)linux_timer_settime, AUE_NULL },	/* 260 = linux_timer_settime */
	{ SYF_MPSAFE | AS(linux_timer_gettime_args), (sy_call_t *)linux_timer_gettime, AUE_NULL },	/* 261 = linux_timer_gettime */
	{ SYF_MPSAFE | AS(linux_timer_getoverrun_args), (sy_call_t *)linux_timer_getoverrun, AUE_NULL },	/* 262 = linux_timer_getoverrun */
	{ SYF_MPSAFE | AS(linux_timer_delete_args), (sy_call_t *)linux_timer_delete, AUE_NULL },	/* 263 = linux_timer_delete */
