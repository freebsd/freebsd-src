...
# $FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1.2.1.8.1 2012/03/03 06:15:13 kensmith Exp $
...
echo '# $FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1.2.1.8.1 2012/03/03 06:15:13 kensmith Exp $' >> Makefile.hfs
...
echo '$FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1.2.1.8.1 2012/03/03 06:15:13 kensmith Exp $' >> $OUTPUT_FILE.bz2.uu
