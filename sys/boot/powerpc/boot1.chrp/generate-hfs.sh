...
# $FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1.2.1.4.1 2010/06/14 02:09:06 kensmith Exp $
...
echo '# $FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1.2.1.4.1 2010/06/14 02:09:06 kensmith Exp $' >> Makefile.hfs
...
echo '$FreeBSD: src/sys/boot/powerpc/boot1.chrp/generate-hfs.sh,v 1.1.2.1.4.1 2010/06/14 02:09:06 kensmith Exp $' >> $OUTPUT_FILE.bz2.uu
