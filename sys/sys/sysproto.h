...
int	freebsd10_mknod(struct thread *, struct freebsd10_mknod_args *);
int	freebsd10_stat(struct thread *, struct freebsd10_stat_args *);
int	freebsd10_fstat(struct thread *, struct freebsd10_fstat_args *);
int	freebsd10_lstat(struct thread *, struct freebsd10_lstat_args *);
int	freebsd10_getdirentries(struct thread *, struct freebsd10_getdirentries_args *);
int	freebsd10_getdents(struct thread *, struct freebsd10_getdents_args *);
int	freebsd10_nstat(struct thread *, struct freebsd10_nstat_args *);
int	freebsd10_nfstat(struct thread *, struct freebsd10_nfstat_args *);
int	freebsd10_nlstat(struct thread *, struct freebsd10_nlstat_args *);
int	freebsd10_fhstat(struct thread *, struct freebsd10_fhstat_args *);
int	freebsd10_getfsstat(struct thread *, struct freebsd10_getfsstat_args *);
int	freebsd10_statfs(struct thread *, struct freebsd10_statfs_args *);
int	freebsd10_fstatfs(struct thread *, struct freebsd10_fstatfs_args *);
int	freebsd10_fhstatfs(struct thread *, struct freebsd10_fhstatfs_args *);
int	freebsd10_fstatat(struct thread *, struct freebsd10_fstatat_args *);
int	freebsd10_mknodat(struct thread *, struct freebsd10_mknodat_args *);
...
#define	SYS_AUE_freebsd10_mknod	AUE_MKNOD
...
#define	SYS_AUE_freebsd10_stat	AUE_STAT
#define	SYS_AUE_freebsd10_fstat	AUE_FSTAT
#define	SYS_AUE_freebsd10_lstat	AUE_LSTAT
...
#define	SYS_AUE_freebsd10_getdirentries	AUE_GETDIRENTRIES
...
#define	SYS_AUE_freebsd10_getdents	AUE_O_GETDENTS
#define	SYS_AUE_lchmod	AUE_LCHMOD
#define	SYS_AUE_lutimes	AUE_LUTIMES
#define	SYS_AUE_freebsd10_nstat	AUE_STAT
#define	SYS_AUE_freebsd10_nfstat	AUE_FSTAT
#define	SYS_AUE_freebsd10_nlstat	AUE_LSTAT
...
#define	SYS_AUE_freebsd10_fhstat	AUE_FHSTAT
...
#define	SYS_AUE_freebsd10_getfsstat	AUE_GETFSSTAT
#define	SYS_AUE_freebsd10_statfs	AUE_STATFS
#define	SYS_AUE_freebsd10_fstatfs	AUE_FSTATFS
#define	SYS_AUE_freebsd10_fhstatfs	AUE_FHSTATFS
...
#define	SYS_AUE_freebsd10_fstatat	AUE_FSTATAT
...
#define	SYS_AUE_freebsd10_mknodat	AUE_MKNODAT
