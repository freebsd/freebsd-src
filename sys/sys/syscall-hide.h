 ...
 * $FreeBSD: src/sys/sys/syscall-hide.h,v 1.49.2.2 2000/05/01 11:18:46 peter Exp $
 * created from FreeBSD: src/sys/kern/syscalls.master,v 1.55.2.3 2000/05/01 11:17:45 peter Exp 
 */
