 ...
 * $FreeBSD: src/sys/sys/syscall-hide.h,v 1.65.2.10 2002/07/12 08:23:08 alfred Exp $
 * created from FreeBSD: src/sys/kern/syscalls.master,v 1.72.2.9 2002/03/09 04:43:21 dd Exp 
 */
