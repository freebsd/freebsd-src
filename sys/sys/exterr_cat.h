...
#define	_EXTERR_CAT_SRC_SHIFT		28
#define	EXTERR_CAT_SRC_MASK		(0xf << _EXTERR_CAT_SRC_SHIFT)

#define	EXTERR_CAT_SRC_KERN_STATIC	(0 << _EXTERR_CAT_SRC_SHIFT)
#define	EXTERR_CAT_SRC_KERN_DYNAMIC	(1 << _EXTERR_CAT_SRC_SHIFT)
#define	EXTERR_CAT_SRC_USER		(2 << _EXTERR_CAT_SRC_SHIFT)

#define	EXTERR_CAT_SRC(c)	((c) & EXTERR_CAT_SRC_MASK)
#define	EXTERR_CAT(c)		((c) & ~EXTERR_CAT_SRC_MASK)

#define	EXTERR_CAT_NONE		0
...
#define	EXTERR_CAT_GEOMZONED	23
