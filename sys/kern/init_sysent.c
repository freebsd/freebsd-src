...
struct sysent sysent[] = {
	...
	{ SYF_MPSAFE | AS(quotactl_args), (sy_call_t *)quotactl },	/* 148 = quotactl */
	...
	{ SYF_MPSAFE | AS(ntp_gettime_args), (sy_call_t *)ntp_gettime },	/* 248 = ntp_gettime */
	...
	{ compat4(SYF_MPSAFE | AS(freebsd4_fhstatfs_args),fhstatfs) },	/* 297 = old fhstatfs */
	{ SYF_MPSAFE | AS(fhopen_args), (sy_call_t *)fhopen },	/* 298 = fhopen */
	{ SYF_MPSAFE | AS(fhstat_args), (sy_call_t *)fhstat },	/* 299 = fhstat */
	...
	{ SYF_MPSAFE | AS(kenv_args), (sy_call_t *)kenv },	/* 390 = kenv */
	...
	{ SYF_MPSAFE | AS(fhstatfs_args), (sy_call_t *)fhstatfs },	/* 398 = fhstatfs */
