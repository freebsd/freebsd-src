 ...
 * $FreeBSD: src/sys/kern/init_sysent.c,v 1.253.2.6.2.1 2012/03/03 06:15:13 kensmith Exp $
...
struct sysent sysent[] = {
	...
	{ compat(AS(ofstat_args),fstat), AUE_FSTAT, NULL, 0, 0, 0 },	/* 62 = old fstat */
	...
	{ compat(AS(ommap_args),mmap), AUE_MMAP, NULL, 0, 0, 0 },	/* 71 = old mmap */
	...
	{ AS(select_args), (sy_call_t *)select, AUE_SELECT, NULL, 0, 0, 0 },	/* 93 = select */
	...
	{ compat(AS(accept_args),accept), AUE_ACCEPT, NULL, 0, 0, 0 },	/* 99 = old accept */
	{ AS(getpriority_args), (sy_call_t *)getpriority, AUE_GETPRIORITY, NULL, 0, 0, 0 },	/* 100 = getpriority */
	{ compat(AS(osend_args),send), AUE_SEND, NULL, 0, 0, 0 },	/* 101 = old send */
	{ compat(AS(orecv_args),recv), AUE_RECV, NULL, 0, 0, 0 },	/* 102 = old recv */
	...
	{ compat(AS(orecvmsg_args),recvmsg), AUE_RECVMSG, NULL, 0, 0, 0 },	/* 113 = old recvmsg */
	{ compat(AS(osendmsg_args),sendmsg), AUE_SENDMSG, NULL, 0, 0, 0 },	/* 114 = old sendmsg */
	...
	{ AS(readv_args), (sy_call_t *)readv, AUE_READV, NULL, 0, 0, 0 },	/* 120 = readv */
	{ AS(writev_args), (sy_call_t *)writev, AUE_WRITEV, NULL, 0, 0, 0 },	/* 121 = writev */
	...
	{ compat(AS(recvfrom_args),recvfrom), AUE_RECVFROM, NULL, 0, 0, 0 },	/* 125 = old recvfrom */
	...
	{ compat(AS(oftruncate_args),ftruncate), AUE_FTRUNCATE, NULL, 0, 0, 0 },	/* 130 = old ftruncate */
	...
	{ compat(AS(ogetpeername_args),getpeername), AUE_GETPEERNAME, NULL, 0, 0, 0 },	/* 141 = old getpeername */
	...
	{ compat(AS(getsockname_args),getsockname), AUE_GETSOCKNAME, NULL, 0, 0, 0 },	/* 150 = old getsockname */
	...
	{ AS(freebsd6_pread_args), (sy_call_t *)freebsd6_pread, AUE_PREAD, NULL, 0, 0, 0 },	/* 173 = freebsd6_pread */
	{ AS(freebsd6_pwrite_args), (sy_call_t *)freebsd6_pwrite, AUE_PWRITE, NULL, 0, 0, 0 },	/* 174 = freebsd6_pwrite */
	...
	{ AS(fstat_args), (sy_call_t *)fstat, AUE_FSTAT, NULL, 0, 0, 0 },	/* 189 = fstat */
	...
	{ AS(getdirentries_args), (sy_call_t *)getdirentries, AUE_GETDIRENTRIES, NULL, 0, 0, 0 },	/* 196 = getdirentries */
	{ AS(freebsd6_mmap_args), (sy_call_t *)freebsd6_mmap, AUE_MMAP, NULL, 0, 0, 0 },	/* 197 = freebsd6_mmap */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0 },		/* 198 = __syscall */
	{ AS(freebsd6_lseek_args), (sy_call_t *)freebsd6_lseek, AUE_LSEEK, NULL, 0, 0, 0 },	/* 199 = freebsd6_lseek */
	{ AS(freebsd6_truncate_args), (sy_call_t *)freebsd6_truncate, AUE_TRUNCATE, NULL, 0, 0, 0 },	/* 200 = freebsd6_truncate */
	{ AS(freebsd6_ftruncate_args), (sy_call_t *)freebsd6_ftruncate, AUE_FTRUNCATE, NULL, 0, 0, 0 },	/* 201 = freebsd6_ftruncate */
	{ AS(sysctl_args), (sy_call_t *)__sysctl, AUE_SYSCTL, NULL, 0, 0, 0 },	/* 202 = __sysctl */
	...
	{ AS(futimes_args), (sy_call_t *)futimes, AUE_FUTIMES, NULL, 0, 0, 0 },	/* 206 = futimes */
	...
	{ AS(preadv_args), (sy_call_t *)preadv, AUE_PREADV, NULL, 0, 0, 0 },	/* 289 = preadv */
	{ AS(pwritev_args), (sy_call_t *)pwritev, AUE_PWRITEV, NULL, 0, 0, 0 },	/* 290 = pwritev */
	...
	{ AS(nnpfs_syscall_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0 },	/* 339 = nnpfs_syscall */
	...
	{ AS(kevent_args), (sy_call_t *)kevent, AUE_NULL, NULL, 0, 0, 0 },	/* 363 = kevent */
	...
	{ AS(afs3_syscall_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0 },	/* 377 = afs3_syscall */
	...
	{ AS(pread_args), (sy_call_t *)pread, AUE_PREAD, NULL, 0, 0, 0 },	/* 475 = pread */
	{ AS(pwrite_args), (sy_call_t *)pwrite, AUE_PWRITE, NULL, 0, 0, 0 },	/* 476 = pwrite */
	{ AS(mmap_args), (sy_call_t *)mmap, AUE_MMAP, NULL, 0, 0, 0 },	/* 477 = mmap */
	{ AS(lseek_args), (sy_call_t *)lseek, AUE_LSEEK, NULL, 0, 0, 0 },	/* 478 = lseek */
	{ AS(truncate_args), (sy_call_t *)truncate, AUE_TRUNCATE, NULL, 0, 0, 0 },	/* 479 = truncate */
	{ AS(ftruncate_args), (sy_call_t *)ftruncate, AUE_FTRUNCATE, NULL, 0, 0, 0 },	/* 480 = ftruncate */
	...
	{ AS(fexecve_args), (sy_call_t *)fexecve, AUE_FEXECVE, NULL, 0, 0, 0 },	/* 492 = fexecve */
