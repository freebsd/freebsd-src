...
const char *syscallnames[] = {
	...
	"helloworld",			/* 588 = helloworld */
	"dbquery",			/* 589 = dbquery */
	"dbq_prepare_v2",				/* 590 = dbq_prepare_v2 */
	"dbq_step",				/* 591 = dbq_step */
	"dbqSafetyCheckOk",				/* 592 = dbqSafetyCheckOk */
	"dbq_mutex_enter",		/* 593 = dbq_mutex_enter */
	"dbqError",				/* 594 = dbqError */
	"dbq_column_count",		/* 595 = dbq_column_count */
	"dbqDbMallocRaw", 		/* 596 = dbqDbMallocRaw */
	"dbq_column_name",		/* 597 = dbq_column_name */
	"dbq_column_text",		/* 598 = dbq_column_text */
	"dbq_column_type",		/* 599 = dbq_column_type */
	"dbqOomFault",			/* 600 = dbqOomFault */
	"dbqVdbeFinalize",		/* 601 = dbqVdbeFinalize */
	"dbqIsspace",			/* 602 = dbqIsspace */
	"dbqDbFree",			/* 603 = dbqDbFree */
	"dbqApiExit",			/* 604 = dbqApiExit */
	"dbqDbStrDup",			/* 605 = dbqDbStrDup */
	"dbqAssert",			/* 606 = dbqAssert */
	"dbq_mutex_leave",		/* 607 = dbq_mutex_leave */
};
