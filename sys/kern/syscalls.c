...
const char *syscallnames[] = {
	...
	"chdir",			/* 12 = chdir */
	"fchdir",			/* 13 = fchdir */
	"compat10.mknod",		/* 14 = freebsd10 mknod */
	"chmod",			/* 15 = chmod */
	"chown",			/* 16 = chown */
	"break",			/* 17 = break */
	...
	"#187",			/* 187 = lfs_segwait */
	"compat10.stat",		/* 188 = freebsd10 stat */
	"compat10.fstat",		/* 189 = freebsd10 fstat */
	"compat10.lstat",		/* 190 = freebsd10 lstat */
	"pathconf",			/* 191 = pathconf */
	"fpathconf",			/* 192 = fpathconf */
	"#193",			/* 193 = nosys */
	"getrlimit",			/* 194 = getrlimit */
	"setrlimit",			/* 195 = setrlimit */
	"compat10.getdirentries",		/* 196 = freebsd10 getdirentries */
	...
	"#270",			/* 270 = nosys */
	"#271",			/* 271 = nosys */
	"compat10.getdents",		/* 272 = freebsd10 getdents */
	"#273",			/* 273 = nosys */
	"lchmod",			/* 274 = lchmod */
	"netbsd_lchown",			/* 275 = netbsd_lchown */
	"lutimes",			/* 276 = lutimes */
	"netbsd_msync",			/* 277 = netbsd_msync */
	"compat10.nstat",		/* 278 = freebsd10 nstat */
	"compat10.nfstat",		/* 279 = freebsd10 nfstat */
	"compat10.nlstat",		/* 280 = freebsd10 nlstat */
	"#281",			/* 281 = nosys */
	"#282",			/* 282 = nosys */
	"#283",			/* 283 = nosys */
	"#284",			/* 284 = nosys */
	...
	"fhopen",			/* 298 = fhopen */
	"compat10.fhstat",		/* 299 = freebsd10 fhstat */
	"modnext",			/* 300 = modnext */
	"modstat",			/* 301 = modstat */
	...
	"fexecve",			/* 492 = fexecve */
	"compat10.fstatat",		/* 493 = freebsd10 fstatat */
	"futimesat",			/* 494 = futimesat */
	"linkat",			/* 495 = linkat */
	"mkdirat",			/* 496 = mkdirat */
	"mkfifoat",			/* 497 = mkfifoat */
	"compat10.mknodat",		/* 498 = freebsd10 mknodat */
	"openat",			/* 499 = openat */
