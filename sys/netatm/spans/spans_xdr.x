...
% *
% *	@(#) $FreeBSD: src/sys/netatm/spans/spans_xdr.x,v 1.5.16.1 2008/10/02 02:57:24 kensmith Exp $
% *
% */
%
/*
...
%
%#ifndef lint
%static const char RCSid[] = "@(#) $FreeBSD: src/sys/netatm/spans/spans_xdr.x,v 1.5.16.1 2008/10/02 02:57:24 kensmith Exp $";
%#endif
%
#endif
