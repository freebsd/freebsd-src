 ...
 *
 *	@(#) $FreeBSD: src/sys/netatm/uni/unisig_encode.c,v 1.12 2002/11/08 18:27:30 jhb Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/sys/netatm/uni/unisig_encode.c,v 1.12 2002/11/08 18:27:30 jhb Exp $");
#endif
