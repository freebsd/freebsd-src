...
struct sysent freebsd32_sysent[] = {
	...
	{ .sy_narg = AS(freebsd32_osdb_step_args), .sy_call = (sy_call_t *)freebsd32_osdb_step, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 590 = freebsd32_osdb_step */
	{ .sy_narg = AS(freebsd32_osdb_finalize_args), .sy_call = (sy_call_t *)freebsd32_osdb_finalize, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 591 = freebsd32_osdb_finalize */
	{ .sy_narg = AS(freebsd32_osdb_column_blob_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_blob, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 592 = freebsd32_osdb_column_blob */
	{ .sy_narg = AS(freebsd32_osdb_column_double_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_double, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 593 = freebsd32_osdb_column_double */
	{ .sy_narg = AS(freebsd32_osdb_column_int_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_int, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 594 = freebsd32_osdb_column_int */
	{ .sy_narg = AS(freebsd32_osdb_column_int64_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_int64, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 595 = freebsd32_osdb_column_int64 */
	{ .sy_narg = AS(freebsd32_osdb_column_text_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_text, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 596 = freebsd32_osdb_column_text */
	{ .sy_narg = AS(freebsd32_osdb_column_text16_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_text16, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 597 = freebsd32_osdb_column_text16 */
	{ .sy_narg = AS(freebsd32_osdb_column_value_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_value, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 598 = freebsd32_osdb_column_value */
	{ .sy_narg = AS(freebsd32_osdb_column_bytes_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_bytes, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 599 = freebsd32_osdb_column_bytes */
	{ .sy_narg = AS(freebsd32_osdb_column_bytes16_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_bytes16, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 600 = freebsd32_osdb_column_bytes16 */
	{ .sy_narg = AS(freebsd32_osdb_column_type_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_type, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 601 = freebsd32_osdb_column_type */
	{ .sy_narg = AS(freebsd32_osdb_column_count_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_count, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 602 = freebsd32_osdb_column_count */
	{ .sy_narg = AS(freebsd32_osdb_column_name_args), .sy_call = (sy_call_t *)freebsd32_osdb_column_name, .sy_auevent = AUE_NULL, .sy_flags = 0, .sy_thrcnt = SY_THR_STATIC },	/* 603 = freebsd32_osdb_column_name */
};
