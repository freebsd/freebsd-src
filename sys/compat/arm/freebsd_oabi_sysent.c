...
struct sysent freebsd_oabi_sysent[] = {
	...
	{ AS(freebsd_oabi_wait4_args), (sy_call_t *)freebsd_oabi_wait4, AUE_WAIT4, NULL, 0, 0, 0, SY_THR_STATIC },	/* 7 = freebsd_oabi_wait4 */
	...
	{ compat(AS(ofreebsd_oabi_sigprocmask_args),freebsd_oabi_sigprocmask), AUE_SIGPROCMASK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 48 = old freebsd_oabi_sigprocmask */
	...
	{ 0, (sy_call_t *)sigpending, AUE_SIGPENDING, NULL, 0, 0, 0, SY_THR_STATIC },	/* 52 = sigpending */
	{ AS(sigaltstack_args), (sy_call_t *)sigaltstack, AUE_SIGALTSTACK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 53 = sigaltstack */
	{ AS(ioctl_args), (sy_call_t *)ioctl, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 54 = ioctl */
	...
	{ AS(freebsd_oabi_setitimer_args), (sy_call_t *)freebsd_oabi_setitimer, AUE_SETITIMER, NULL, 0, 0, 0, SY_THR_STATIC },	/* 83 = freebsd_oabi_setitimer */
	...
	{ AS(freebsd_oabi_getitimer_args), (sy_call_t *)freebsd_oabi_getitimer, AUE_GETITIMER, NULL, 0, 0, 0, SY_THR_STATIC },	/* 86 = freebsd_oabi_getitimer */
	...
	{ AS(freebsd_oabi_select_args), (sy_call_t *)freebsd_oabi_select, AUE_SELECT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 93 = freebsd_oabi_select */
	...
	{ compat(AS(ofreebsd_oabi_sigvec_args),freebsd_oabi_sigvec), AUE_O_SIGVEC, NULL, 0, 0, 0, SY_THR_STATIC },	/* 108 = old freebsd_oabi_sigvec */
	{ compat(AS(ofreebsd_oabi_sigblock_args),freebsd_oabi_sigblock), AUE_O_SIGBLOCK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 109 = old freebsd_oabi_sigblock */
	{ compat(AS(ofreebsd_oabi_sigsetmask_args),freebsd_oabi_sigsetmask), AUE_O_SIGSETMASK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 110 = old freebsd_oabi_sigsetmask */
	{ compat(AS(ofreebsd_oabi_sigsuspend_args),freebsd_oabi_sigsuspend), AUE_SIGSUSPEND, NULL, 0, 0, 0, SY_THR_STATIC },	/* 111 = old freebsd_oabi_sigsuspend */
	{ compat(AS(ofreebsd_oabi_sigstack_args),freebsd_oabi_sigstack), AUE_O_SIGSTACK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 112 = old freebsd_oabi_sigstack */
	...
	{ AS(freebsd_oabi_gettimeofday_args), (sy_call_t *)freebsd_oabi_gettimeofday, AUE_GETTIMEOFDAY, NULL, 0, 0, 0, SY_THR_STATIC },	/* 116 = freebsd_oabi_gettimeofday */
	{ AS(freebsd_oabi_getrusage_args), (sy_call_t *)freebsd_oabi_getrusage, AUE_GETRUSAGE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 117 = freebsd_oabi_getrusage */
	...
	{ AS(freebsd_oabi_settimeofday_args), (sy_call_t *)freebsd_oabi_settimeofday, AUE_SETTIMEOFDAY, NULL, 0, 0, 0, SY_THR_STATIC },	/* 122 = freebsd_oabi_settimeofday */
	...
	{ AS(freebsd_oabi_utimes_args), (sy_call_t *)freebsd_oabi_utimes, AUE_UTIMES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 138 = freebsd_oabi_utimes */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 139 = obsolete 4.2 sigreturn */
	{ AS(freebsd_oabi_adjtime_args), (sy_call_t *)freebsd_oabi_adjtime, AUE_ADJTIME, NULL, 0, 0, 0, SY_THR_STATIC },	/* 140 = freebsd_oabi_adjtime */
	...
	{ AS(freebsd_oabi_semsys_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 169 = freebsd_oabi_semsys */
	{ AS(freebsd_oabi_msgsys_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 170 = freebsd_oabi_msgsys */
	{ AS(freebsd_oabi_shmsys_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 171 = freebsd_oabi_shmsys */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 172 = nosys */
	{ compat6(AS(freebsd6_freebsd6_pread_args),freebsd6_pread), AUE_PREAD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 173 = freebsd6 freebsd6_pread */
	{ compat6(AS(freebsd6_freebsd6_pwrite_args),freebsd6_pwrite), AUE_PWRITE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 174 = freebsd6 freebsd6_pwrite */
	...
	{ AS(freebsd_oabi_stat_args), (sy_call_t *)freebsd_oabi_stat, AUE_STAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 188 = freebsd_oabi_stat */
	{ AS(freebsd_oabi_fstat_args), (sy_call_t *)freebsd_oabi_fstat, AUE_FSTAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 189 = freebsd_oabi_fstat */
	{ AS(freebsd_oabi_lstat_args), (sy_call_t *)freebsd_oabi_lstat, AUE_LSTAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 190 = freebsd_oabi_lstat */
	...
	{ compat6(AS(freebsd6_freebsd6_mmap_args),freebsd6_mmap), AUE_MMAP, NULL, 0, 0, 0, SY_THR_STATIC },	/* 197 = freebsd6 freebsd6_mmap */
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },		/* 198 = __syscall */
	{ compat6(AS(freebsd6_freebsd6_lseek_args),freebsd6_lseek), AUE_LSEEK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 199 = freebsd6 freebsd6_lseek */
	{ compat6(AS(freebsd6_freebsd6_truncate_args),freebsd6_truncate), AUE_TRUNCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 200 = freebsd6 freebsd6_truncate */
	{ compat6(AS(freebsd6_freebsd6_ftruncate_args),freebsd6_ftruncate), AUE_FTRUNCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 201 = freebsd6 freebsd6_ftruncate */
	...
	{ AS(freebsd_oabi_futimes_args), (sy_call_t *)freebsd_oabi_futimes, AUE_FUTIMES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 206 = freebsd_oabi_futimes */
	...
	{ 0, (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },		/* 224 = freebsd7 freebsd_oabi_msgctl */
	{ AS(msgget_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 225 = msgget */
	{ AS(freebsd_oabi_msgsnd_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 226 = freebsd_oabi_msgsnd */
	{ AS(freebsd_oabi_msgrcv_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 227 = freebsd_oabi_msgrcv */
	{ AS(shmat_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 228 = shmat */
	{ 0, (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },		/* 229 = freebsd7 freebsd_oabi_shmctl */
	...
	{ AS(freebsd_oabi_clock_gettime_args), (sy_call_t *)freebsd_oabi_clock_gettime, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 232 = freebsd_oabi_clock_gettime */
	{ AS(freebsd_oabi_clock_settime_args), (sy_call_t *)freebsd_oabi_clock_settime, AUE_CLOCK_SETTIME, NULL, 0, 0, 0, SY_THR_STATIC },	/* 233 = freebsd_oabi_clock_settime */
	{ AS(freebsd_oabi_clock_getres_args), (sy_call_t *)freebsd_oabi_clock_getres, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 234 = freebsd_oabi_clock_getres */
	...
	{ AS(freebsd_oabi_nanosleep_args), (sy_call_t *)freebsd_oabi_nanosleep, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 240 = freebsd_oabi_nanosleep */
	...
	{ AS(freebsd_oabi_aio_read_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 255 = freebsd_oabi_aio_read */
	{ AS(freebsd_oabi_aio_write_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 256 = freebsd_oabi_aio_write */
	{ AS(freebsd_oabi_lio_listio_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 257 = freebsd_oabi_lio_listio */
	...
	{ AS(freebsd_oabi_lutimes_args), (sy_call_t *)freebsd_oabi_lutimes, AUE_LUTIMES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 276 = freebsd_oabi_lutimes */
	...
	{ AS(freebsd_oabi_preadv_args), (sy_call_t *)freebsd_oabi_preadv, AUE_PREADV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 289 = freebsd_oabi_preadv */
	{ AS(freebsd_oabi_pwritev_args), (sy_call_t *)freebsd_oabi_pwritev, AUE_PWRITEV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 290 = freebsd_oabi_pwritev */
	...
	{ AS(freebsd_oabi_aio_return_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 314 = freebsd_oabi_aio_return */
	{ AS(freebsd_oabi_aio_suspend_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 315 = freebsd_oabi_aio_suspend */
	{ AS(freebsd_oabi_aio_cancel_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 316 = freebsd_oabi_aio_cancel */
	{ AS(freebsd_oabi_aio_error_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 317 = freebsd_oabi_aio_error */
	{ AS(freebsd_oabi_oaio_read_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 318 = freebsd_oabi_oaio_read */
	{ AS(freebsd_oabi_oaio_write_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 319 = freebsd_oabi_oaio_write */
	{ AS(freebsd_oabi_olio_listio_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 320 = freebsd_oabi_olio_listio */
	...
	{ AS(freebsd_oabi_sched_rr_get_interval_args), (sy_call_t *)freebsd_oabi_sched_rr_get_interval, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 334 = freebsd_oabi_sched_rr_get_interval */
	...
	{ compat4(AS(freebsd4_freebsd_oabi_sigreturn_args),freebsd_oabi_sigreturn), AUE_SIGRETURN, NULL, 0, 0, 0, SY_THR_STATIC },	/* 344 = freebsd4 freebsd_oabi_sigreturn */
	{ AS(freebsd_oabi_sigtimedwait_args), (sy_call_t *)freebsd_oabi_sigtimedwait, AUE_SIGWAIT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 345 = freebsd_oabi_sigtimedwait */
	...
	{ AS(freebsd_oabi_aio_waitcomplete_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 359 = freebsd_oabi_aio_waitcomplete */
	...
	{ AS(freebsd_oabi_kevent_args), (sy_call_t *)freebsd_oabi_kevent, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 363 = freebsd_oabi_kevent */
	...
	{ AS(freebsd_oabi_ksem_init_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 404 = freebsd_oabi_ksem_init */
	{ AS(freebsd_oabi_ksem_open_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 405 = freebsd_oabi_ksem_open */
	...
	{ AS(freebsd_oabi_ksem_timedwait_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 441 = freebsd_oabi_ksem_timedwait */
	...
	{ AS(freebsd_oabi_kmq_timedreceive_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 459 = freebsd_oabi_kmq_timedreceive */
	{ AS(freebsd_oabi_kmq_timedsend_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 460 = freebsd_oabi_kmq_timedsend */
	...
	{ AS(freebsd_oabi_aio_fsync_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 465 = freebsd_oabi_aio_fsync */
	...
	{ AS(freebsd_oabi_pread_args), (sy_call_t *)freebsd_oabi_pread, AUE_PREAD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 475 = freebsd_oabi_pread */
	{ AS(freebsd_oabi_pwrite_args), (sy_call_t *)freebsd_oabi_pwrite, AUE_PWRITE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 476 = freebsd_oabi_pwrite */
	{ AS(freebsd_oabi_mmap_args), (sy_call_t *)freebsd_oabi_mmap, AUE_MMAP, NULL, 0, 0, 0, SY_THR_STATIC },	/* 477 = freebsd_oabi_mmap */
	{ AS(freebsd_oabi_lseek_args), (sy_call_t *)freebsd_oabi_lseek, AUE_LSEEK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 478 = freebsd_oabi_lseek */
	{ AS(freebsd_oabi_truncate_args), (sy_call_t *)freebsd_oabi_truncate, AUE_TRUNCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 479 = freebsd_oabi_truncate */
	{ AS(freebsd_oabi_ftruncate_args), (sy_call_t *)freebsd_oabi_ftruncate, AUE_FTRUNCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 480 = freebsd_oabi_ftruncate */
	...
	{ AS(freebsd_oabi_cpuset_setid_args), (sy_call_t *)freebsd_oabi_cpuset_setid, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 485 = freebsd_oabi_cpuset_setid */
	...
	{ AS(freebsd_oabi_fstatat_args), (sy_call_t *)freebsd_oabi_fstatat, AUE_FSTATAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 493 = freebsd_oabi_fstatat */
	{ AS(freebsd_oabi_futimesat_args), (sy_call_t *)freebsd_oabi_futimesat, AUE_FUTIMESAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 494 = freebsd_oabi_futimesat */
	...
	{ AS(freebsd_oabi_msgctl_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 511 = freebsd_oabi_msgctl */
	{ AS(freebsd_oabi_shmctl_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 512 = freebsd_oabi_shmctl */
	...
	{ AS(freebsd_oabi_pselect_args), (sy_call_t *)freebsd_oabi_pselect, AUE_SELECT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 522 = freebsd_oabi_pselect */
};
