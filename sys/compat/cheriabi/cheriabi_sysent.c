...
#define PAD64_REQUIRED
	...
	{ AS(cheriabi_recvmsg_args), (sy_call_t *)cheriabi_recvmsg, AUE_RECVMSG, NULL, 0, 0, 0, SY_THR_STATIC },	/* 27 = cheriabi_recvmsg */
	{ AS(cheriabi_sendmsg_args), (sy_call_t *)cheriabi_sendmsg, AUE_SENDMSG, NULL, 0, 0, 0, SY_THR_STATIC },	/* 28 = cheriabi_sendmsg */
	{ AS(recvfrom_args), (sy_call_t *)sys_recvfrom, AUE_RECVFROM, NULL, 0, 0, 0, SY_THR_STATIC },	/* 29 = recvfrom */
	...
	{ AS(cheriabi_sigaltstack_args), (sy_call_t *)cheriabi_sigaltstack, AUE_SIGALTSTACK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 53 = cheriabi_sigaltstack */
	{ AS(cheriabi_ioctl_args), (sy_call_t *)cheriabi_ioctl, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 54 = cheriabi_ioctl */
	...
	{ AS(setitimer_args), (sy_call_t *)sys_setitimer, AUE_SETITIMER, NULL, 0, 0, 0, SY_THR_STATIC },	/* 83 = setitimer */
	...
	{ AS(getitimer_args), (sy_call_t *)sys_getitimer, AUE_GETITIMER, NULL, 0, 0, 0, SY_THR_STATIC },	/* 86 = getitimer */
	...
	{ AS(select_args), (sy_call_t *)sys_select, AUE_SELECT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 93 = select */
	...
	{ AS(gettimeofday_args), (sy_call_t *)sys_gettimeofday, AUE_GETTIMEOFDAY, NULL, 0, 0, 0, SY_THR_STATIC },	/* 116 = gettimeofday */
	{ AS(getrusage_args), (sy_call_t *)sys_getrusage, AUE_GETRUSAGE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 117 = getrusage */
	...
	{ AS(cheriabi_readv_args), (sy_call_t *)cheriabi_readv, AUE_READV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 120 = cheriabi_readv */
	{ AS(cheriabi_writev_args), (sy_call_t *)cheriabi_writev, AUE_WRITEV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 121 = cheriabi_writev */
	...
	{ AS(fstat_args), (sy_call_t *)sys_fstat, AUE_FSTAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 189 = fstat */
	...
	{ AS(getdirentries_args), (sy_call_t *)sys_getdirentries, AUE_GETDIRENTRIES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 196 = getdirentries */
	...
	{ AS(sysctl_args), (sy_call_t *)sys___sysctl, AUE_SYSCTL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 202 = __sysctl */
	...
	{ AS(futimes_args), (sy_call_t *)sys_futimes, AUE_FUTIMES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 206 = futimes */
	...
	{ 0, (sy_call_t *)nosys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },			/* 220 = obsolete semctl */
	...
	{ AS(clock_gettime_args), (sy_call_t *)sys_clock_gettime, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 232 = clock_gettime */
	{ AS(clock_settime_args), (sy_call_t *)sys_clock_settime, AUE_CLOCK_SETTIME, NULL, 0, 0, 0, SY_THR_STATIC },	/* 233 = clock_settime */
	{ AS(clock_getres_args), (sy_call_t *)sys_clock_getres, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 234 = clock_getres */
	{ AS(cheriabi_ktimer_create_args), (sy_call_t *)cheriabi_ktimer_create, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 235 = cheriabi_ktimer_create */
	{ AS(ktimer_delete_args), (sy_call_t *)sys_ktimer_delete, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 236 = ktimer_delete */
	{ AS(ktimer_settime_args), (sy_call_t *)sys_ktimer_settime, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 237 = ktimer_settime */
	{ AS(ktimer_gettime_args), (sy_call_t *)sys_ktimer_gettime, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 238 = ktimer_gettime */
	{ AS(ktimer_getoverrun_args), (sy_call_t *)sys_ktimer_getoverrun, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 239 = ktimer_getoverrun */
	{ AS(nanosleep_args), (sy_call_t *)sys_nanosleep, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 240 = nanosleep */
	...
	{ AS(cheriabi_aio_read_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 255 = cheriabi_aio_read */
	{ AS(cheriabi_aio_write_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 256 = cheriabi_aio_write */
	{ AS(cheriabi_lio_listio_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 257 = cheriabi_lio_listio */
	...
	{ AS(cheriabi_preadv_args), (sy_call_t *)cheriabi_preadv, AUE_PREADV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 289 = cheriabi_preadv */
	{ AS(cheriabi_pwritev_args), (sy_call_t *)cheriabi_pwritev, AUE_PWRITEV, NULL, 0, 0, 0, SY_THR_STATIC },	/* 290 = cheriabi_pwritev */
	...
	{ AS(cheriabi_aio_return_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 314 = cheriabi_aio_return */
	{ AS(cheriabi_aio_suspend_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 315 = cheriabi_aio_suspend */
	{ AS(cheriabi_aio_cancel_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 316 = cheriabi_aio_cancel */
	{ AS(cheriabi_aio_error_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 317 = cheriabi_aio_error */
	...
	{ AS(cheriabi_sigtimedwait_args), (sy_call_t *)cheriabi_sigtimedwait, AUE_SIGWAIT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 345 = cheriabi_sigtimedwait */
	{ AS(cheriabi_sigwaitinfo_args), (sy_call_t *)cheriabi_sigwaitinfo, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 346 = cheriabi_sigwaitinfo */
	...
	{ AS(cheriabi_aio_waitcomplete_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 359 = cheriabi_aio_waitcomplete */
	...
	{ AS(cheriabi_kevent_args), (sy_call_t *)cheriabi_kevent, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 363 = cheriabi_kevent */
	...
	{ AS(cheriabi_sendfile_args), (sy_call_t *)cheriabi_sendfile, AUE_SENDFILE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 393 = cheriabi_sendfile */
	...
	{ AS(cheriabi_sigaction_args), (sy_call_t *)cheriabi_sigaction, AUE_SIGACTION, NULL, 0, 0, 0, SY_THR_STATIC },	/* 416 = cheriabi_sigaction */
	{ AS(cheriabi_sigreturn_args), (sy_call_t *)cheriabi_sigreturn, AUE_SIGRETURN, NULL, 0, 0, 0, SY_THR_STATIC },	/* 417 = cheriabi_sigreturn */
	...
	{ AS(cheriabi_getcontext_args), (sy_call_t *)cheriabi_getcontext, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 421 = cheriabi_getcontext */
	{ AS(cheriabi_setcontext_args), (sy_call_t *)cheriabi_setcontext, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 422 = cheriabi_setcontext */
	...
	{ AS(thr_suspend_args), (sy_call_t *)sys_thr_suspend, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 442 = thr_suspend */
	...
	{ AS(_umtx_op_args), (sy_call_t *)sys__umtx_op, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 454 = _umtx_op */
	{ AS(cheriabi_thr_new_args), (sy_call_t *)cheriabi_thr_new, AUE_NULL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 455 = cheriabi_thr_new */
	...
	{ AS(cheriabi_kmq_notify_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 461 = cheriabi_kmq_notify */
	...
	{ AS(cheriabi_aio_fsync_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 465 = cheriabi_aio_fsync */
	...
	{ AS(cheriabi_sctp_generic_sendmsg_iov_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 473 = cheriabi_sctp_generic_sendmsg_iov */
	{ AS(cheriabi_sctp_generic_recvmsg_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 474 = cheriabi_sctp_generic_recvmsg */
	{ AS(pread_args), (sy_call_t *)sys_pread, AUE_PREAD, NULL, 0, 0, 0, SY_THR_STATIC },	/* 475 = pread */
	{ AS(pwrite_args), (sy_call_t *)sys_pwrite, AUE_PWRITE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 476 = pwrite */
	{ AS(mmap_args), (sy_call_t *)sys_mmap, AUE_MMAP, NULL, 0, 0, 0, SY_THR_STATIC },	/* 477 = mmap */
	{ AS(lseek_args), (sy_call_t *)sys_lseek, AUE_LSEEK, NULL, 0, 0, 0, SY_THR_STATIC },	/* 478 = lseek */
	{ AS(truncate_args), (sy_call_t *)sys_truncate, AUE_TRUNCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 479 = truncate */
	{ AS(ftruncate_args), (sy_call_t *)sys_ftruncate, AUE_FTRUNCATE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 480 = ftruncate */
	...
	{ AS(cheriabi_fexecve_args), (sy_call_t *)cheriabi_fexecve, AUE_FEXECVE, NULL, 0, 0, 0, SY_THR_STATIC },	/* 492 = cheriabi_fexecve */
	{ AS(fstatat_args), (sy_call_t *)sys_fstatat, AUE_FSTATAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 493 = fstatat */
	{ AS(futimesat_args), (sy_call_t *)sys_futimesat, AUE_FUTIMESAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 494 = futimesat */
	...
	{ AS(cheriabi_semctl_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, 0, SY_THR_ABSENT },	/* 510 = cheriabi_semctl */
	...
	{ 0, (sy_call_t *)cheriabi_cap_enter, AUE_CAP_ENTER, NULL, 0, 0, 0, SY_THR_STATIC },	/* 516 = cheriabi_cap_enter */
	...
	{ AS(cheriabi_cap_ioctls_limit_args), (sy_call_t *)cheriabi_cap_ioctls_limit, AUE_CAP_IOCTLS_LIMIT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 534 = cheriabi_cap_ioctls_limit */
	{ AS(cheriabi_cap_ioctls_get_args), (sy_call_t *)cheriabi_cap_ioctls_get, AUE_CAP_IOCTLS_GET, NULL, 0, 0, 0, SY_THR_STATIC },	/* 535 = cheriabi_cap_ioctls_get */
	...
	{ AS(futimens_args), (sy_call_t *)sys_futimens, AUE_FUTIMES, NULL, 0, 0, 0, SY_THR_STATIC },	/* 546 = futimens */
	{ AS(utimensat_args), (sy_call_t *)sys_utimensat, AUE_FUTIMESAT, NULL, 0, 0, 0, SY_THR_STATIC },	/* 547 = utimensat */
};
