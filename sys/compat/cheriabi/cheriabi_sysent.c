...
#define PAD64_REQUIRED
	...
	{ AS(cheriabi___semctl_args), (sy_call_t *)cheriabi___semctl, AUE_SEMCTL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 510 = cheriabi___semctl */
	{ AS(cheriabi_msgctl_args), (sy_call_t *)cheriabi_msgctl, AUE_MSGCTL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 511 = cheriabi_msgctl */
	{ AS(shmctl_args), (sy_call_t *)sys_shmctl, AUE_SHMCTL, NULL, 0, 0, 0, SY_THR_STATIC },	/* 512 = shmctl */
