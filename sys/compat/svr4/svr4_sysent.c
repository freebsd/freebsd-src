...
struct sysent svr4_sysent[] = {
	...
	{ 0, (sy_call_t *)fork, AUE_NULL },		/* 2 = fork */
	...
	{ AS(close_args), (sy_call_t *)close, AUE_NULL },	/* 6 = close */
	...
	{ AS(setuid_args), (sy_call_t *)setuid, AUE_NULL },	/* 23 = setuid */
	{ 0, (sy_call_t *)getuid, AUE_NULL },		/* 24 = getuid */
	...
	{ 0, (sy_call_t *)svr4_sys_pause, AUE_NULL },	/* 29 = svr4_sys_pause */
	...
	{ AS(svr4_sys_nice_args), (sy_call_t *)svr4_sys_nice, AUE_NULL },	/* 34 = svr4_sys_nice */
	{ 0, (sy_call_t *)nosys, AUE_NULL },			/* 35 = statfs */
	{ 0, (sy_call_t *)sync, AUE_NULL },		/* 36 = sync */
	{ AS(svr4_sys_kill_args), (sy_call_t *)svr4_sys_kill, AUE_NULL },	/* 37 = svr4_sys_kill */
	{ 0, (sy_call_t *)nosys, AUE_NULL },			/* 38 = fstatfs */
	{ AS(svr4_sys_pgrpsys_args), (sy_call_t *)svr4_sys_pgrpsys, AUE_NULL },	/* 39 = svr4_sys_pgrpsys */
	{ 0, (sy_call_t *)nosys, AUE_NULL },			/* 40 = xenix */
	{ AS(dup_args), (sy_call_t *)dup, AUE_NULL },	/* 41 = dup */
	{ 0, (sy_call_t *)pipe, AUE_NULL },		/* 42 = pipe */
	...
	{ AS(setgid_args), (sy_call_t *)setgid, AUE_NULL },	/* 46 = setgid */
	{ 0, (sy_call_t *)getgid, AUE_NULL },		/* 47 = getgid */
	{ AS(svr4_sys_signal_args), (sy_call_t *)svr4_sys_signal, AUE_NULL },	/* 48 = svr4_sys_signal */
	...
	{ AS(umask_args), (sy_call_t *)umask, AUE_NULL },	/* 60 = umask */
	{ AS(chroot_args), (sy_call_t *)chroot, AUE_NULL },	/* 61 = chroot */
	{ AS(svr4_sys_fcntl_args), (sy_call_t *)svr4_sys_fcntl, AUE_NULL },	/* 62 = svr4_sys_fcntl */
	{ AS(svr4_sys_ulimit_args), (sy_call_t *)svr4_sys_ulimit, AUE_NULL },	/* 63 = svr4_sys_ulimit */
	...
	{ AS(getgroups_args), (sy_call_t *)getgroups, AUE_NULL },	/* 91 = getgroups */
	{ AS(setgroups_args), (sy_call_t *)setgroups, AUE_NULL },	/* 92 = setgroups */
	...
	{ AS(svr4_sys_sigsuspend_args), (sy_call_t *)svr4_sys_sigsuspend, AUE_NULL },	/* 96 = svr4_sys_sigsuspend */
	{ AS(svr4_sys_sigaltstack_args), (sy_call_t *)svr4_sys_sigaltstack, AUE_NULL },	/* 97 = svr4_sys_sigaltstack */
	{ AS(svr4_sys_sigaction_args), (sy_call_t *)svr4_sys_sigaction, AUE_NULL },	/* 98 = svr4_sys_sigaction */
	{ AS(svr4_sys_sigpending_args), (sy_call_t *)svr4_sys_sigpending, AUE_NULL },	/* 99 = svr4_sys_sigpending */
	...
	{ AS(mprotect_args), (sy_call_t *)mprotect, AUE_NULL },	/* 116 = mprotect */
	{ AS(munmap_args), (sy_call_t *)munmap, AUE_NULL },	/* 117 = munmap */
	{ AS(svr4_sys_fpathconf_args), (sy_call_t *)svr4_sys_fpathconf, AUE_NULL },	/* 118 = svr4_sys_fpathconf */
	{ 0, (sy_call_t *)vfork, AUE_NULL },		/* 119 = vfork */
	...
	{ AS(svr4_sys_setrlimit_args), (sy_call_t *)svr4_sys_setrlimit, AUE_NULL },	/* 128 = svr4_sys_setrlimit */
	{ AS(svr4_sys_getrlimit_args), (sy_call_t *)svr4_sys_getrlimit, AUE_NULL },	/* 129 = svr4_sys_getrlimit */
	...
	{ AS(setegid_args), (sy_call_t *)setegid, AUE_NULL },	/* 136 = setegid */
	{ AS(svr4_sys_sysconfig_args), (sy_call_t *)svr4_sys_sysconfig, AUE_NULL },	/* 137 = svr4_sys_sysconfig */
	{ AS(adjtime_args), (sy_call_t *)adjtime, AUE_NULL },	/* 138 = adjtime */
	...
	{ AS(seteuid_args), (sy_call_t *)seteuid, AUE_NULL },	/* 141 = seteuid */
	...
	{ AS(getitimer_args), (sy_call_t *)getitimer, AUE_NULL },	/* 157 = getitimer */
	{ AS(setitimer_args), (sy_call_t *)setitimer, AUE_NULL },	/* 158 = setitimer */
	...
	{ AS(nanosleep_args), (sy_call_t *)nanosleep, AUE_NULL },	/* 199 = nanosleep */
	{ AS(svr4_sys_facl_args), (sy_call_t *)svr4_sys_facl, AUE_NULL },	/* 200 = svr4_sys_facl */
	{ 0, (sy_call_t *)nosys, AUE_NULL },			/* 201 = door */
	{ AS(setreuid_args), (sy_call_t *)setreuid, AUE_NULL },	/* 202 = setreuid */
	{ AS(setregid_args), (sy_call_t *)setregid, AUE_NULL },	/* 203 = setregid */
	...
	{ AS(svr4_sys_setrlimit64_args), (sy_call_t *)svr4_sys_setrlimit64, AUE_NULL },	/* 220 = svr4_sys_setrlimit64 */
	{ AS(svr4_sys_getrlimit64_args), (sy_call_t *)svr4_sys_getrlimit64, AUE_NULL },	/* 221 = svr4_sys_getrlimit64 */
