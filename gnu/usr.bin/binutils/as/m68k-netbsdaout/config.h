/* $FreeBSD: src/gnu/usr.bin/binutils/as/m68k-netbsdaout/config.h,v 1.1.2.1 2000/07/06 22:15:46 obrien Exp $ */
...
#define TARGET_ALIAS "m68k-unknown-netbsd"
#define TARGET_CPU "m68k"
#define TARGET_CANONICAL "m68k-unknown-netbsd"
