/* $FreeBSD: src/gnu/usr.bin/binutils/as/powerpc-freebsd/config.h,v 1.1 1999/11/06 22:16:58 jb Exp $ */
...
#define TARGET_ALIAS "powerpc-unknown-freebsdelf"
#define TARGET_CPU "powerpc"
#define TARGET_CANONICAL "powerpc-unknown-freebsdelf"
