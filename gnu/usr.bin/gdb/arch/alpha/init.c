/* $FreeBSD: src/gnu/usr.bin/gdb/arch/alpha/init.c,v 1.2.12.1 2008/10/02 02:57:24 kensmith Exp $ */
...
extern initialize_file_ftype _initialize_alphafbsd_tdep;
...
extern initialize_file_ftype _initialize_core_regset;
