...
#
# $FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.56.1.8.1 2012/03/03 06:15:13 kensmith Exp $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.56.1.8.1 2012/03/03 06:15:13 kensmith Exp $' . "\n"; # 'emacs kludge
	exit 0;
    }
