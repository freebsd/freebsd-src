...
#
# $FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.56.1.2.1 2009/10/25 01:10:29 kensmith Exp $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.56.1.2.1 2009/10/25 01:10:29 kensmith Exp $' . "\n"; # 'emacs kludge
	exit 0;
    }
