...
#
# $FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.58.1 2010/02/10 00:26:20 kensmith Exp $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.58.1 2010/02/10 00:26:20 kensmith Exp $' . "\n"; # 'emacs kludge
	exit 0;
    }
