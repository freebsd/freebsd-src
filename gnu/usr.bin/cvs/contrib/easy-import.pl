...
#
# $FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.52.1 2008/11/25 02:59:29 kensmith Exp $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.52.1 2008/11/25 02:59:29 kensmith Exp $' . "\n"; # 'emacs kludge
	exit 0;
    }
