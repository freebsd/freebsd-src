...
#
# $FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.60.1 2010/12/21 17:10:29 kensmith Exp $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.60.1 2010/12/21 17:10:29 kensmith Exp $' . "\n"; # 'emacs kludge
	exit 0;
    }
