...
#
# $FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.56.1.6.1 2010/12/21 17:09:25 kensmith Exp $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.16.56.1.6.1 2010/12/21 17:09:25 kensmith Exp $' . "\n"; # 'emacs kludge
	exit 0;
    }
