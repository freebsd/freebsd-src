...
#
# $FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.14.2.2 1999/12/13 20:57:25 peter Exp $
...
sub scan_opts
{
    ...
    if($opt_v) {
	print STDERR '$FreeBSD: src/gnu/usr.bin/cvs/contrib/easy-import.pl,v 1.14.2.2 1999/12/13 20:57:25 peter Exp $' . "\n"; # 'emacs kludge
	exit 0;
    }
