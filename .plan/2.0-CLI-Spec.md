...
- [6. Tooling and Management Interface](#6-tooling-and-management-interface)
  - [6.1 Core CLI: `ocifbsd`](#61-core-cli-ocifbsd)
  - [6.2 Configuration File](#62-configuration-file)
  - [6.3 rc.d Script](#63-rcd-script)
  - [6.4 Detailed CLI Command Reference](#64-detailed-cli-command-reference)
    - [6.4.1 Global Flags](#641-global-flags)
    - [6.4.2 Image Management Commands](#642-image-management-commands)
    - [6.4.3 Container Lifecycle Commands](#643-container-lifecycle-commands)
    - [6.4.4 Low-Level OCI Runtime Commands](#644-low-level-oci-runtime-commands)
    - [6.4.5 Network Commands](#645-network-commands)
    - [6.4.6 Volume Commands](#646-volume-commands)
    - [6.4.7 System Commands](#647-system-commands)
  - [6.5 Docker/Podman Compatibility Layer](#65-dockerpodman-compatibility-layer)
    - [6.5.1 Compatibility Wrapper: `docker` and `podman` Aliases](#651-compatibility-wrapper-docker-and-podman-aliases)
    - [6.5.2 Compatibility Configuration](#652-compatibility-configuration)
    - [6.5.3 Unsupported Docker Features (Documented)](#653-unsupported-docker-features-documented)
  - [6.6 User Workflow Examples](#66-user-workflow-examples)
    - [6.6.1 Getting Started: First Container](#661-getting-started-first-container)
    - [6.6.2 Development Workflow](#662-development-workflow)
    - [6.6.3 Production Deployment Workflow](#663-production-deployment-workflow)
    - [6.6.4 Database and Service Stack](#664-database-and-service-stack)
    - [6.6.5 Backup and Maintenance](#665-backup-and-maintenance)
    - [6.6.6 Troubleshooting Workflow](#666-troubleshooting-workflow)
  - [6.7 Multi-Container Orchestration: `ocifbsd compose`](#67-multi-container-orchestration-ocifbsd-compose)
    - [6.7.1 Compose File Format](#671-compose-file-format)
    - [6.7.2 Compose Commands](#672-compose-commands)
    - [6.7.3 Compose FreeBSD Extensions](#673-compose-freebsd-extensions)
  - [6.8 Containerfile / OCIfile Format](#68-containerfile--ocifile-format)
    - [6.8.1 Supported Instructions](#681-supported-instructions)
    - [6.8.2 FreeBSD-Specific Extensions](#682-freebsd-specific-extensions)
    - [6.8.3 Example Containerfile](#683-example-containerfile)
    - [6.8.4 Build Command](#684-build-command)
  - [6.9 Output Formats and Filtering](#69-output-formats-and-filtering)
    - [6.9.1 Standard Output Formats](#691-standard-output-formats)
    - [6.9.2 Filtering](#692-filtering)
    - [6.9.3 libxo Integration](#693-libxo-integration)
  - [6.10 Integration with Existing FreeBSD Tools](#610-integration-with-existing-freebsd-tools)
    - [6.10.1 Jail Integration](#6101-jail-integration)
    - [6.10.2 ZFS Integration](#6102-zfs-integration)
    - [6.10.3 Network Integration](#6103-network-integration)
    - [6.10.4 Resource Control Integration](#6104-resource-control-integration)
    - [6.10.5 Service Integration](#6105-service-integration)
    - [6.10.6 Package Management Integration](#6106-package-management-integration)
  - [6.11 Shell Completion](#611-shell-completion)
  - [6.12 Migration Guide: Docker/Podman to ocifbsd](#612-migration-guide-dockerpodman-to-ocifbsd)
    - [6.12.1 Command Mapping Quick Reference](#6121-command-mapping-quick-reference)
    - [6.12.2 Dockerfile to Containerfile Migration](#6122-dockerfile-to-containerfile-migration)
    - [6.12.3 docker-compose.yml to oci-compose.yml Migration](#6123-docker-composeyml-to-oci-composeyml-migration)
