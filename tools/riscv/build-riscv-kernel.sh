...
info "Building RISC-V DTBs..."
python3 "$FREEBSD_SRC/tools/build/make.py" "${MAKE_ARGS[@]}" -C "$FREEBSD_SRC/sys/modules/dtb/starfive" || \
    echo -e "${BLUE}[WARN]${NC} DTB build failed. Ensure 'starfive' dtb directory exists."
