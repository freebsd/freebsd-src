 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarp_timer.c,v 1.4.30.1 2008/10/02 02:57:24 kensmith Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarp_timer.c,v 1.4.30.1 2008/10/02 02:57:24 kensmith Exp $");
#endif
