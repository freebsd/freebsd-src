 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarpd.c,v 1.6.26.1 2008/10/02 02:57:24 kensmith Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarpd.c,v 1.6.26.1 2008/10/02 02:57:24 kensmith Exp $");
#endif
