 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarp_subr.c,v 1.5.26.1 2008/10/02 02:57:24 kensmith Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarp_subr.c,v 1.5.26.1 2008/10/02 02:57:24 kensmith Exp $");
#endif
