 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarp_subr.c,v 1.4 2002/05/16 23:28:40 arr Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/atmarpd/atmarp_subr.c,v 1.4 2002/05/16 23:28:40 arr Exp $");
#endif
