 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/scspd/scspd.c,v 1.6.24.1 2008/10/02 02:57:24 kensmith Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/scspd/scspd.c,v 1.6.24.1 2008/10/02 02:57:24 kensmith Exp $");
#endif
