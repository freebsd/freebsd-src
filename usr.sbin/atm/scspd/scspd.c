 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/scspd/scspd.c,v 1.5 2002/07/02 10:51:09 naddy Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/scspd/scspd.c,v 1.5 2002/07/02 10:51:09 naddy Exp $");
#endif
