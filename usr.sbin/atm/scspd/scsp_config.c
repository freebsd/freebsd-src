 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/scspd/scsp_config.c,v 1.5.30.1 2008/10/02 02:57:24 kensmith Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/scspd/scsp_config.c,v 1.5.30.1 2008/10/02 02:57:24 kensmith Exp $");
#endif
