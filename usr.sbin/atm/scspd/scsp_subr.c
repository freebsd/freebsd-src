 ...
 *
 *	@(#) $FreeBSD: src/usr.sbin/atm/scspd/scsp_subr.c,v 1.4 2002/05/16 23:57:37 arr Exp $
 *
 */
...
#ifndef lint
__RCSID("@(#) $FreeBSD: src/usr.sbin/atm/scspd/scsp_subr.c,v 1.4 2002/05/16 23:57:37 arr Exp $");
#endif
