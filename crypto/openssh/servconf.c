...
/* $FreeBSD: src/crypto/openssh/servconf.c,v 1.51.2.4.2.1 2012/03/03 06:15:13 kensmith Exp $ */
/*
...
#include "includes.h"
__RCSID("$FreeBSD: src/crypto/openssh/servconf.c,v 1.51.2.4.2.1 2012/03/03 06:15:13 kensmith Exp $");
