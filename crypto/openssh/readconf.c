...
/* $FreeBSD: src/crypto/openssh/readconf.c,v 1.31.2.3.2.1 2012/03/03 06:15:13 kensmith Exp $ */
/*
...
#include "includes.h"
__RCSID("$FreeBSD: src/crypto/openssh/readconf.c,v 1.31.2.3.2.1 2012/03/03 06:15:13 kensmith Exp $");
