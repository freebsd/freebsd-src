 ...
 */
#define EVIOCGMTSLOTS(len)	_IOC(IOC_OUT, 'E', 0x0a, len)
...
#define EVIOCSFF		_IOC(IOC_IN, 'E', 0x80, sizeof(struct ff_effect))	/* send a force effect to a force feedback device */
