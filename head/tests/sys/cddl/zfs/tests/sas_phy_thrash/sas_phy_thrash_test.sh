...
atf_test_case sas_phy_thrash_001_pos cleanup
...
sas_phy_thrash_001_pos_body()
{
	...
	ksh93 $(atf_get_srcdir)/sas_phy_thrash_001_pos.ksh || atf_fail "Testcase failed"
}
...
atf_init_test_cases()
{
	...
	atf_add_test_case sas_phy_thrash_001_pos
}
