...
atf_test_case cross_endian_001_pos cleanup
...
cross_endian_001_pos_body()
{
	...
	ksh93 $(atf_get_srcdir)/cross_endian_001_pos.ksh || atf_fail "Testcase failed"
}
...
atf_test_case cross_endian_002_pos cleanup
...
cross_endian_002_pos_body()
{
	...
	ksh93 $(atf_get_srcdir)/setup.ksh || atf_fail "Setup failed"
	ksh93 $(atf_get_srcdir)/cross_endian_002_pos.ksh || atf_fail "Testcase failed"
}
...
atf_init_test_cases()
{
	...
	atf_add_test_case cross_endian_001_pos
	atf_add_test_case cross_endian_002_pos
}
